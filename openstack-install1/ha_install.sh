...
Example:
        ha_install.sh [-L] -v openstack_controller_vip [-r repo_files]
...
first_openstack_controller=${this_ip}
...
yum -y install --disablerepo=* --enablerepo=${REPO_FILES} keepalived haproxy xinetd
